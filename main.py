...
paredSup = box(pos = (0, 6, 0), size = (12, 0.2, 12), color = color.green)
paredInf = box(pos = (0, -6, 0), size = (12, 0.2, 12), color = color.green)

paredTrasera = box(pos = (0, 0, -6), size = (12, 12, 0.2), color = color.green)
paredFrontal = box(pos = (0, 0, 6), size = (12, 12, 0.2), color = color.green, opacity = 0.01)

particula.velocity = vector(25, 5, 5)
...
particula.trail = curve(color=particula.color)
...
while t < 100:
    ...
    if particula.pos.z >= paredFrontal.pos.z or particula.pos.y < paredTrasera.pos.y:
